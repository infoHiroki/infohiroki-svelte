<svelte:head>
  ...
  <meta name="twitter:title" content="生成AI導入実績 | infoHiroki">
  <meta name="twitter:description" content="実際の導入事例と成果をご紹介">

  <!-- Canonical URL -->
  <link rel="canonical" href="https://infohiroki.com/results">
</svelte:head>

<div class="hero-sub">
  <div class="container">
    <h1 class="page-title">生成AI導入実績</h1>
  </div>
</div>
